...
namespace Tavernkeep.Domain.Evaluators.Modifiers
{
	public class CharacterModifierEvaluator(Character character, params ICollection<string> target) : IValueEvaluator<int>
	{
