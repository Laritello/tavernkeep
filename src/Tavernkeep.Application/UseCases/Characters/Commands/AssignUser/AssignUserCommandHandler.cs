...
{
    public class AssignUserCommandHandler(IUserRepository userRepository, ICharacterRepository characterRepository) : IRequestHandler<AssignUserCommand, Character>
    {
