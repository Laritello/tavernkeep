...
<template>
    ...
    <div class="flex flex-col overflow-clip h-full">
        ...
        <footer class="sticky bottom-0 btm-nav min-h-16 lg:hidden">
            <RouterLink active-class="active text-info" to="/combat"> Combat </RouterLink>
            <RouterLink active-class="active text-info" to="/"> Character </RouterLink>
            <RouterLink active-class="active text-info" to="/chat"> Chat </RouterLink>
        </footer>
        <!--  /Bottom navbar  -->
    </div>
    <!-- /Mobile layout -->
