<template>
    <div class="bg-base-100 border-2 rounded-xl border-inherit flex flex-col p-2 w-full lg:max-w-md">
        <div class="flex flex-row justify-center items-center">
            <h2 class="mr-1 text-lg font-semibold select-none">Saving Throws</h2>
            <button class="btn-sm btn-circle" @click="showEditSavingThrowsDialog()">
        ...
        <div class="grid grid-cols-3">
            <SavingThrowView v-for="savingThrow in savingThrows" :savingThrow="savingThrow" :key="savingThrow.type"
...
async function showEditSavingThrowsDialog() {
    ...
    const result = await modal.show(SavingThrowsEditDialog, {
        savingThrows,
    });
