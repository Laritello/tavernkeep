            ...
            <div class="flex flex-row pt-1 px-1">
                ...
                <div class="flex flex-col flex-1 h-full gap-1">
                    ...
                    <div class="self-stretch px-2">
                        <HealthBar :health="user.activeCharacter.value.health" class="h-6"
                ...
                <div class="flex-none w-24">
                    <div class="flex flex-col gap-1">
                        <div class="flex flex-row">
                            <PerceptionBadge :perception="user.activeCharacter.value.perception" class="w-12" @roll="performPerceptionCheck"/>
